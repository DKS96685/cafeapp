    ...
    return (
        <div className="cancel-container">
            <div className="cancel-card">
                ...
                <p>Your payment was cancelled. No charges were made. Your order has been saved but remains unpaid.</p>
                <div className="button-group">
                    <Link href="/checkout" className="primary-btn">Try Again</Link>
